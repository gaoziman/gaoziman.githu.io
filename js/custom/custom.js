// "" === GLOBAL_CONFIG_SITE.title.replace("爱笑的Gao的个人博客", "") ? document.getElementById("page-name-text").style.display = "none" : document.querySelector("#page-name-text>span").innerHTML = document.title.split(" | 爱笑的Gao的个人博客")[0];
